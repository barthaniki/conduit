...
class TestPost():
  ...
  def test_post(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(1) > .form-control").send_keys("testuser1@example.com")
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(2) > .form-control").click()
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(2) > .form-control").send_keys("Abcd123$")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".form-group:nth-child(3) > .form-control").send_keys("my article")
    self.driver.find_element(By.CSS_SELECTOR, ".ti-new-tag-input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".ti-new-tag-input").send_keys("tag")
    self.driver.find_element(By.CSS_SELECTOR, ".btn").click()
